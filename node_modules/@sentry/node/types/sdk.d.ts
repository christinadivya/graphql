...
import { Console, Context, ContextLines, Http, LinkedErrors, OnUncaughtException, OnUnhandledRejection } from './integrations';
import { NodeOptions } from './types';
export declare const defaultIntegrations: (Console | Http | OnUncaughtException | OnUnhandledRejection | ContextLines | LinkedErrors | Context | CoreIntegrations.InboundFilters | CoreIntegrations.FunctionToString)[];
/**
