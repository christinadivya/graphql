...
function parseBaggageHeader(
  ...
  if ((!Array.isArray(inputBaggageValue) && !is.isString(inputBaggageValue)) || typeof inputBaggageValue === 'number') {
    (typeof __SENTRY_DEBUG__ === 'undefined' || __SENTRY_DEBUG__) &&
      logger.logger.warn(
  ...
  var baggageEntries = (is.isString(inputBaggageValue) ? inputBaggageValue : inputBaggageValue.join(','))
    .split(',')
